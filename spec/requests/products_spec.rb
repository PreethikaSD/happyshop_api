...
RSpec.describe 'Items API' do
  ...
  describe 'POST /categories/:category_id/products' do
    let(:valid_attributes) { { name: 'Lipbalm', price: 100 } }
    ...
    context 'when request attributes are valid' do
      ...
      it 'returns status code 201' do
        ...
        expect(Product.last).to have_attributes valid_attributes
        expect { post "/categories/#{category_id}/products", params: valid_attributes }.to change(Product, :count).by(+1)
      end
    end
    ...
    context 'when an invalid request' do
      ...
      it 'returns a failure message' do
        expect(response.body).to match(/Validation failed: Name can't be blank, Price can't be blank/)
  ...
  describe 'PUT /categories/:category_id/products/:id' do
    let(:valid_attributes) { { name: 'Lakme' } }
    ...
    context 'when product exists' do
      ...
      it 'updates the product' do
        ...
        expect(updated_product.name).to match(/Lakme/)
      end
    end
